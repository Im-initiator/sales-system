...
<body>
<c:url var="urlCategoryGender" value="${api}"/><%--/api/manager/gender--%>
<c:url var="urlList" value="${link}"/><%--manager/gender--%>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button id="submitCategory" type="button" class="btn btn-primary"
                ...
                <div class="table-responsive">
                    <table id="mytable" class="table table-bordred table-striped">
                        ...
                        <th><input type="checkbox" id="checkall"/>
                            <button type="button" class="btn text-danger" id="delete-product"><i
                        ...
                        <c:forEach items="${model}" var="gender" varStatus="loop">
                            <tr>
                                ...
                                <sec:authorize access="hasRole('MANAGER')">
                                    <td><i class="bi bi-pencil-square bs-bx p-2 edit-category" data-bs-toggle="modal"
                                           data-bs-target="#ModelEdit" id="${loop.index}"></i></td>
                                </sec:authorize>
                            </tr>
                        </c:forEach>
                        </tbody>
