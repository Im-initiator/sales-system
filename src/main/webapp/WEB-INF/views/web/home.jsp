        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 p-0">
                    ...
                    data-setbg="<c:url value='${model[0].thumbnail}'/> ">
...
<section class="banner set-bg" data-setbg="<c:url value='/template/web/img/banner/banner-1.jpg'/>">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
                ...
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="<c:url value='/template/web/img/trend/ht-1.jpg'/>" alt="">
                        </div>
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="<c:url value='/template/web/img/trend/ht-2.jpg'/>" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="<c:url value='/template/web/img/trend/ht-3.jpg'/>" alt="">
                        </div>
                        <div class="trend__item__text">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="<c:url value='/template/web/img/trend/bs-1.jpg'/>" alt="">
                        </div>
                        <div class="trend__item__text">
                            <h6>Cotton T-Shirt</h6>
                            <div class="rating">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="<c:url value='/template/web/img/trend/bs-2.jpg'/>" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="<c:url value='/template/web/img/trend/bs-3.jpg'/>" alt="">
                        </div>
                        <div class="trend__item__text">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="<c:url value='/template/web/img/trend/f-1.jpg'/>" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="<c:url value='/template/web/img/trend/f-2.jpg'/>" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="<c:url value='/template/web/img/trend/f-3.jpg'/>" alt="">
                        </div>
                        <div class="trend__item__text">
        ...
        <div class="row">
            <div class="col-lg-6 p-0">
                <div class="discount__pic">
                    <img src="<c:url value='/template/web/img/discount.jpg'/>" alt="">
                </div>
            </div>
            <div class="col-lg-6 p-0">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                <div class="instagram__item set-bg" data-setbg="<c:url value='/template/web/img/instagram/insta-1.jpg'/>">
            ...
            <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                <div class="instagram__item set-bg" data-setbg="<c:url value='/template/web/img/instagram/insta-2.jpg'/>">
                    <div class="instagram__text">
                        <i class="fa fa-instagram"></i>
                        <a href="#">@ ashion_shop</a>
                    </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                <div class="instagram__item set-bg" data-setbg="<c:url value='/template/web/img/instagram/insta-3.jpg'/>">
                    <div class="instagram__text">
                        <i class="fa fa-instagram"></i>
                        <a href="#">@ ashion_shop</a>
                    </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                <div class="instagram__item set-bg" data-setbg="<c:url value='/template/web/img/instagram/insta-4.jpg'/>">
                    <div class="instagram__text">
                        <i class="fa fa-instagram"></i>
                        <a href="#">@ ashion_shop</a>
                    </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                <div class="instagram__item set-bg" data-setbg="<c:url value='/template/web/img/instagram/insta-5.jpg'/>">
                    <div class="instagram__text">
                        <i class="fa fa-instagram"></i>
                        <a href="#">@ ashion_shop</a>
                    </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                <div class="instagram__item set-bg" data-setbg="<c:url value='/template/web/img/instagram/insta-6.jpg'/>">
                    <div class="instagram__text">
                        <i class="fa fa-instagram"></i>
                        <a href="#">@ ashion_shop</a>
                    </div>
